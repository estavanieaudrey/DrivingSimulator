class Sensor {
  ...
  group_readings() {
    ...
    for (let i=0; i<this.readings.length; i++) {
      ...
      switch (i) {
        case 0:
          left += current_power * this.chromosome[0][0];
          right += current_power * this.chromosome[0][1];
          fwd += current_power * this.chromosome[0][2];
          rvs += current_power * this.chromosome[0][3];
          break;
        case 1:
          left += current_power * this.chromosome[1][0];
          right += current_power * this.chromosome[1][1];
          fwd += current_power * this.chromosome[1][2];
          rvs += current_power * this.chromosome[1][3];
          break;
        case 2:
          left += current_power * this.chromosome[2][0];
          right += current_power * this.chromosome[2][1];
          fwd += current_power * this.chromosome[2][2];
          rvs += current_power * this.chromosome[2][3];
          break;
        case 3:
          left += current_power * this.chromosome[3][0];
          right += current_power * this.chromosome[3][1];
          fwd += current_power * this.chromosome[3][2];
          rvs += current_power * this.chromosome[3][3];
          break;
        case 4:
          left += current_power * this.chromosome[4][0];
          right += current_power * this.chromosome[4][1];
          fwd += current_power * this.chromosome[4][2];
          rvs += current_power * this.chromosome[4][3];
          break;
        case 5:
          left += current_power * this.chromosome[5][0];
          right += current_power * this.chromosome[5][1];
          fwd += current_power * this.chromosome[5][2];
          rvs += current_power * this.chromosome[5][3];
          break;
        case 6:
          left += current_power * this.chromosome[6][0];
          right += current_power * this.chromosome[6][1];
          fwd += current_power * this.chromosome[6][2];
          rvs += current_power * this.chromosome[6][3];
          break;
      }
    }
    ...
    if (this.car.speed < 0) {
      const boost = this.chromosome[7][4];
      rvs *= boost;
      if (left > right) left *= boost;
      if (right > left) right *= boost;
    }

    let rvs_threshold = this.chromosome[7][0];
    let turn_threshold = this.chromosome[7][1];
    const slow_threshold = this.chromosome[7][2];
